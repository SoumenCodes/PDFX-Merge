...
const workpdfx = async (pdf1, pdf2) => {
  ...
  // I Soumen For Seting a new  name to every  merged pdf
 let newName = new Date().getTime();
  await merger.save(`saveFiles/Merged PDFX ${newName}.pdf`); //save under given name and reset the internal document
    return newName;
